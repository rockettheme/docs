...
Clarion, the 13th Magento Club template release, is a subtle theme, primed for business use or as a platform for extensive individual customization.
...
Installing the Clarion theme is quick and easy to do. There are numerous ways to do it, but we will outline the most common method(s) in this tutorial. We will start with the process you will likely want to go through if you are installing Clarion on an existing Magento install.
...
[download]: http://www.rockettheme.com/magento/themes/clarion
