...
Installing the Clarion theme is quick and easy to do. There are numerous ways to do it, but we will outline the most common method(s) in this tutorial. We will start with the process you'll likely want to go through if you are installing Clarion on an existing Magento install.
