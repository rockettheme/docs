...
Kinetic, the 4th Magento Theme release, has a versatile and flexible design, styled with scrupulous precision, and makes the most of the included RokMage extensions.

The template's impressive collection of preset styles - coupled with its many integrated extensions - are key to the design's appeal, offering an array of tools to refine your content. Kinetic suits numerous different types of store, and with its plethora of admin options, can be easily configured to display your products exactly how you want. 
...
Installing the Kinetic theme is quick and easy to do. There are numerous ways to do it, but we will outline the most common method(s) in this tutorial. We will start with the process you will likely want to go through if you are installing Kinetic on an existing Magento install.
...
[download]: http://www.rockettheme.com/magento-downloads/club/1787-kinetic
