...
If you wish to see the theme in a full store setting, you can download the Affinity RocketLauncher. This will install a complete version of Magento, along with all template files and extensions, plus the Magento sample data.
