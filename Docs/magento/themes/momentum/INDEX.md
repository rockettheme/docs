...
Momentum, the 11th Magento Club Theme release, combines an intricate graphical design with the intuitive, full scale background image ContentSlider extension.
...
Installing the Momentum theme is quick and easy to do. There are numerous ways to do it, but we will outline the most common method(s) in this tutorial. We will start with the process you will likely want to go through if you are installing Momentum on an existing Magento install.
...
[download]: http://www.rockettheme.com/magento/themes/momentum
