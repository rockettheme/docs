...
Panacea, the 8th Magento Club Theme release, encapsulates stylistic freedom, with it is striking homepage ContentSlider implementation.
...
Installing the Panacea theme is quick and easy to do. There are numerous ways to do it, but we will outline the most common method(s) in this tutorial. We will start with the process you will likely want to go through if you are installing Panacea on an existing Magento install.
...
[download]: http://www.rockettheme.com/magento-downloads/club/2574-panacea
