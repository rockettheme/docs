...
Quasar is our first dual Free GPL / Members theme released by RocketTheme for Magento. The free version comes with 2 extensions, HomepageTabs and CmsCallouts, whilst the members version has the addition of our RokMage Extensions, all styled to match the theme. Quasar is a very powerful and feature rich template, on a comparable level with our Club Templates in terms of functionality.

With 6 style variations, and admin configurable options for the homepage and sidebar callouts, Quasar is a useful, diverse and functional free template, great for any purpose. 
...
Installing the Quasar theme is quick and easy to do. There are numerous ways to do it, but we will outline the most common method(s) in this tutorial. We will start with the process you will likely want to go through if you are installing Quasar on an existing Magento install.
...
[download]: http://www.rockettheme.com/magento-downloads/club/1978-quasar
