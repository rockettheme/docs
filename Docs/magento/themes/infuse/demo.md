---
title: Infuse: Recreate the Demo
...
You can recreate a number of different elements found on the front page of the Infuse demo by modifying some basic extension settings. Depending on which extension you wish to recreate on the page, you may only need to add and adjust the settings of a single module.

The Infuse theme handles most of the visual details for you.
...
~~~ .html
.cms-index-index #welcome .block-title strong span, .slider-productinfo h3 a, .block .block-title strong span, .page-title h1, .page-title h2, .catalog-product-view .product-name h1, #quick-info-slot h2, .footer h3, #rokmage-login-content h2, .product-view .up-sell h3, .product-view .box-tags h2, #rokmage-header-cart h6, .footer-viewed-title strong span
~~~
