...
Infuse, the 6th Magento Club Theme release, is an infusion of artistic flair and functionality. 

The theme boasts six individual and unique style variations, meticulously constructed to perfection, with our 12 RokMage extensions seamlessly integrated with the design. 
...
Installing the Infuse theme is quick and easy to do. There are numerous ways to do it, but we will outline the most common method(s) in this tutorial. We will start with the process you will likely want to go through if you are installing Infuse on an existing Magento install.
...
[download]: http://www.rockettheme.com/magento-downloads/club/2196-infuse
