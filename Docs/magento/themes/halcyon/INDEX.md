...
Halcyon, the 10th Magento Club Theme release, is elegant and subtle, reflecting a conservative design direction, perfect for commercially orientated sites.
...
Installing the Halcyon theme is quick and easy to do. There are numerous ways to do it, but we will outline the most common method(s) in this tutorial. We will start with the process you will likely want to go through if you are installing Halcyon on an existing Magento install.
...
[download]: http://www.rockettheme.com/magento-downloads/club/2846-halcyon
