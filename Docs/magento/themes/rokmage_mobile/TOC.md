...
* RokMage Mobile
    ...
    * [Setup Guide](setup.md)
        * [RocketTheme Themes](setup.md#how-to-set-up-rokmage-mobile-with-a-rockettheme-template)
        * [Theme Switcher](setup.md#how-to-use-the-)
        * [Third Party Themes](setup.md#how-to-set-up-rokmage-mobile-with-third-party-themes)
        * [Theme Roller](setup.md#how-to-create-a-style-using-theme-roller)