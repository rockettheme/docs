...
Mynxx, the 1st Magento Theme release, is a clean and conservative template, perfect for electrical/tech style stores.

8 preset styles - 4 dark and 4 light - coupled with its many integrated extensions - make for a very versatile store design.
...
Installing the Mynxx theme is quick and easy to do. There are numerous ways to do it, but we will outline the most common method(s) in this tutorial. We will start with the process you will likely want to go through if you are installing Mynxx on an existing Magento install.
...
[theme]: assets/mynxx.jpeg
[rokmagelayout]: assets/RokMageLayout.jpg
[download]: http://www.rockettheme.com/magento/themes/mynxx/modal/downloads
