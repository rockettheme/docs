...
:   1. **Display Limit** The amount of posts to show when rendering. [11%, 47%, sw]
    2. **Theme** This sets the theme for displaying strips in the module. [15%, 72%, sw]
    3. **Article Titles** This toggle enables you to show or hide post titles. [20%, 71%, sw]
    4. **Article Text** This toggle allows you to show or hide post text in a strips. [24%, 49%, sw]
    5. **Preview Length** This option sets the amount of words you wish to limit the preview to within the module's post display. [28%, 68%, sw]
    ...
    13. **Default Title** You can set a default title for all posts from this field. If this selection is set at `Default post Title`, then the post's given titles are used. [73%, 65%, sw]
    14. **Default Article Text** This field allows you to set default post text for all strips in the module. If this is not changed from its default, then the post's introductory text is used. [77%, 65%, sw]
    15. **Default Article Image** Determines which image field the widget will default to when locating an image for the feature. [82%, 67%, sw]
    16. **Default Link** Determines which link field the widget will default to when locating a link for the feature. [86%, 65%, sw]
