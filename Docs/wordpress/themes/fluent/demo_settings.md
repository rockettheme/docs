...
One of the most important aspects of any Gantry theme is its ability to be easily customized using the settings presets in the Theme Settings page. These settings can be adjusted by navigating to **Admin -> Fluent Theme**. To replicate the demo, the styling changes are being made in the **Styles** tab.
