...
The **Portfolio** example page demonstrates how you can create a beautiful page with the Tessellate template. Here is some information to help you replicate this page as it appears in the demo.
...
The **Portfolio** page is a regular **Page**. To recreate the layout the way it appears in our demo, enter `menu-portfolio` in the **Page Suffix** field in the **Gizmos** page inside the **Tessellate** theme settings. This suffix is tied to a class in the demo.less file that sets the page up so it appears the way it does in the demo.
...
<div class="gantry-row">
    ...
    <div class="gantry-width-50">
        <div class="gantry-width-spacer">
            <span class="rt-image">
                <img src="http://demo.rockettheme.com/live/wordpress/tessellate/wp-content/rockettheme/rt_tessellate_wp/pages/portfolio/img-17.jpg" alt="image" />
            </span>
        </div>
    </div>
    ...
    <div class="gantry-width-50">
        <div class="gantry-width-spacer">
            ...
            <div class="clear"></div>
            <p class="largemargintop"><a href="http://www.rockettheme.com/wordpress-themes/tessellate" class="readon">Learn More</a></p>
        </div>
    </div>
</div>
</div>
...
:   1. **Top - Text** [10%, 45%, se]
    2. **Breadcrumbs - Gantry Breadcrumbs** [15%, 14% se]
    3. **Expanded Top - RokSprocket** [18%, 14%, se]
    4. **Main Top - RokSprocket** [45%, 14%, se]
    5. **Mainbody** [54%, 14%, se]
    6. **Extension - Text** [73%, 14%, se]
    7. **Footer - Text** [83%, 14%, se]
    8. **Footer - Text** [83%, 52%, se]

1. [Top - Text](portfolio.md#top-section)
...
4. [Main Top - RokSprocket](portfolio.md#main-top-section)
5. [Mainbody](portfolio.md#mainbody)
6. [Extension - Text](portfolio.md#extension-section)
...
<div class="gantry-row">
    ...
    <div class="gantry-width-20">
        <div class="gantry-width-spacer">
            <a href="http://www.rockettheme.com/wordpress-themes/hadron"><img class="rt-transparent-image" src="http://demo.rockettheme.com/live/wordpress/tessellate/wp-content/rockettheme/rt_tessellate_wp/pages/portfolio/img-18.png" alt="image" /></a>
        </div>
    </div>
    <div class="gantry-width-20">
        <div class="gantry-width-spacer">
            <a href="http://www.rockettheme.com/wordpress-themes/acacia"><img class="rt-transparent-image" src="http://demo.rockettheme.com/live/wordpress/tessellate/wp-content/rockettheme/rt_tessellate_wp/pages/portfolio/img-19.png" alt="image" /></a>
        </div>
    </div>
    <div class="gantry-width-20">
        <div class="gantry-width-spacer">
            <a href="http://www.rockettheme.com/wordpress-themes/corvus"><img class="rt-transparent-image" src="http://demo.rockettheme.com/live/wordpress/tessellate/wp-content/rockettheme/rt_tessellate_wp/pages/portfolio/img-20.png" alt="image" /></a>
        </div>
    </div>
    <div class="gantry-width-20">
        <div class="gantry-width-spacer">
            <a href="http://www.rockettheme.com/wordpress-themes/spectral"><img class="rt-transparent-image" src="http://demo.rockettheme.com/live/wordpress/tessellate/wp-content/rockettheme/rt_tessellate_wp/pages/portfolio/img-21.png" alt="image" /></a>
        </div>
    </div>
    <div class="gantry-width-20">
        <div class="gantry-width-spacer">
            <a href="http://www.rockettheme.com/wordpress-themes/stratos"><img class="rt-transparent-image" src="http://demo.rockettheme.com/live/wordpress/tessellate/wp-content/rockettheme/rt_tessellate_wp/pages/portfolio/img-22.png" alt="image" /></a>
        </div>
    </div>
</div>
</div>
...
[portfolio2]: assets/page_portfolio_2.jpeg
[portfolio3]: assets/page_portfolio_3.jpeg
[portfolio4]: assets/page_portfolio_4.jpeg
[portfolio5]: assets/page_portfolio_5.jpeg
[portfolio6]: assets/page_portfolio_6.jpeg
[portfolio7]: assets/page_portfolio_7.jpeg
[portfolio8]: assets/page_portfolio_8.jpeg
[portfolio9]: assets/page_portfolio_9.jpeg
[portfolio10]: assets/page_portfolio_10.jpeg
[portfolio11]: assets/page_portfolio_11.jpeg
