---
title: Horizon: Block Content Particle
...
| Category           | Choose to **Show** or **Hide** the post category.                                                                                                        |
| Content Type       | Choose to display the full **Content**, an **Exerpt**, or to **Hide** post content.                                                                      |
