...
The **FAQ** example page demonstrates how you can create a beautiful page with the Callisto theme. Here is some information to help you replicate this page as it appears in the demo.
...
This is a look at the **Layout Manager** for the **Callisto - Pages - FAQ** outline. We have detailed the various particles represented here in the sections below.
