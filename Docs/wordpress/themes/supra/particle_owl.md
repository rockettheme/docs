...
| Featured Image       | Sets whether or not the particle will display the post's assigned featured image.                              |
| Post Title           | Sets whether or not the post will display the post's title.                                                    |
| Post Content         | Sets whether or not the post will display the post's content.                                                  |
| Content Type         | Select between **Content** and **Excerpt** which uses content you place in the **Excerpt** field for the post. |
