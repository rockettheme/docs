---
title: Ricochet: Recreating the Demo - About Us Page
...
The **About Us** example page demonstrates how you can create a beautiful page with the Ricochet template. Here is some information to help you replicate this page as it appears in the demo.
...
The **About Us** page is a regular **Page**. To recreate the layout the way it appears in our demo, enter `menu-about-us` in the **Page Suffix** field in the **Gizmos** page inside the **Ricochet** theme settings. This suffix is tied to a class in the demo.less file that sets the page up so it appears the way it does in the demo.
...
:   1. **Feature - Text** [12%, 45%, se]
    2. **Breadcrumbs** [18%, 16%, se]
    3. **Main Top - Text** [22%, 16%, se]
    4. **Expanded Bottom - Text** [37%, 16%, se]
    5. **MainBody Content** [63%, 16%, se]
    6. **Extension - Text** [55%, 30%, se]
    7. **Footer - Text** [76%, 16%, se]
    8. **Footer - Text** [76%, 50%, se]

1. [Feature - Text](aboutus.md#showcase-section)
2. [Breadcrumbs](aboutus.md#breadcrumbs-section)
2. [Main Top - Text](aboutus.md#main-top-section)
3. [Expanded Bottom - Text](aboutus.md#expanded-bottom-section)
4. [MainBody Content](aboutus.md#mainbody)
...
![Feature](assets/page_aboutus_1.jpeg)
...
* Set the **Title** to `About Us[span class="rt-title-tag"]Welcome to Ricochet[/span]`.
...
<div class="gantry-width-container">
    <div class="gantry-width-50">
        <div class="gantry-width-spacer">
            <span class="rt-image"><img src="http://demo.rockettheme.com/live/wordpress/ricochet/wp-content/rockettheme/rt_ricochet_wp/pages/about-us/img-01.jpg" alt="image" /></span>
        </div>
    </div>
...
![Main Bottom](assets/page_aboutus_4.jpeg)
...
<div class="gantry-row">
    <div class="gantry-width-container">
        <div class="gantry-width-33">
            <div class="gantry-width-spacer">
                <span class="rt-image"><img src="http://demo.rockettheme.com/live/wordpress/ricochet/wp-content/rockettheme/rt_ricochet_wp/pages/about-us/img-02.jpg" alt="image" /></span>
                <h4>Our Mission</h4>
        ...
        <div class="gantry-width-33">
            <div class="gantry-width-spacer">
                <span class="rt-image"><img src="http://demo.rockettheme.com/live/wordpress/ricochet/wp-content/rockettheme/rt_ricochet_wp/pages/about-us/img-03.jpg" alt="image" /></span>
                <h4>Our Values</h4>
        ...
        <div class="gantry-width-33">
            <div class="gantry-width-spacer">
                <span class="rt-image"><img src="http://demo.rockettheme.com/live/wordpress/ricochet/wp-content/rockettheme/rt_ricochet_wp/pages/about-us/img-04.jpg" alt="image" /></span>
                <h4>Our Solution</h4>
...
![Extension](assets/page_aboutus_5.jpeg)
...
<p><a href="http://www.rockettheme.com/wordpress-themes/ricochet" class="readon">Download Ricochet</a></p>
~~~
