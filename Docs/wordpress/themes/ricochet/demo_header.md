---
title: Ricochet: Recreating the Demo - Header
...
:   1. **Gantry Logo** [40%, 6%, se]
    2. **Gantry Menu** [40%, 43%, se]
    3. **Gantry Social Buttons** [40%, 85%, se]
...
The first thing you will need to do is click and drag the **Gantry Logo** widget from the **Available Widgets** area of the Widgets menu to the appropriate section. Once this is done, the logo should appear in the upper-left area of the front page as it does in the demo. You can further customize this logo by following the instructions in our [FAQ](faq.md).
