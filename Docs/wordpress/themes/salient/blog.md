...
The **Blog** example page demonstrates how you can create a beautiful page with the Salient theme. Here is some information to help you replicate this page as it appears in the demo.
...
:   1. **Showcase - Custom HTML (Particle)** [5%, 45%, se]
    ...
    3. **Aside - RokAjaxSearch (Widget)** [8%, 75%, se]
    4. **Aside - Text (Widget)** [11%, 75%, se]
    5. **Aside - Login (Widget)** [19%, 75%, se]
    6. **Bottom - Custom HTML (Particle)** [87%, 35%, se]
    7. **Footer - Text (Widget)** [93%, 5%, se]
...
<div class="g-layercontent">
  ...
  <a href="http://www.rockettheme.com/wordpress/themes/salient" class="button button-2">Submit Article</a>
</div>
~~~
