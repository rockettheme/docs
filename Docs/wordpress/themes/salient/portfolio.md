...
The **Portfolio** example page demonstrates how you can create a beautiful page with the Salient theme. Here is some information to help you replicate this page as it appears in the demo.
      ...
      <div class="g-contentlist ">
        <div class="g-grid">
          ...
          <div class="g-block size-67 g-contentlist-text">
            <div class="g-content">
              <h3 class="g-contentlist-headline">Salient Premium Project</h3>
...
<div class="g-layercontent g-layercontent-small">
  ...
  <a href="http://www.rockettheme.com/wordpress/themes/salient" class="button button-2">Join Now</a>
</div>
~~~
