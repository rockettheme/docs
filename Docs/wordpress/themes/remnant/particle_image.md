---
title: Remnant: Image Grid Particle
...
>> Note: You will need the [RokBox](http://www.rockettheme.com/wordpress/plugins/rokbox) plugin installed and active to take advantage of the click-to-view feature.
...
| Layout        | Enables you to select between **Standard** and **Visible Captions** as a layout type.       |
