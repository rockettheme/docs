---
title: Galatea: Recreating the Demo - Theme Settings
...
One of the most important aspects of any Gantry theme is its ability to be easily customized using the settings present in the Theme Settings page. These settings can be adjusted by navigating to **Administration -> Galatea Theme**. To replicate the demo, the styling changes are being made in the **Styles** tab.
