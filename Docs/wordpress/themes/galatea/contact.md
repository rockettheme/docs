...
The contact form featured in the page is generated by WordPress. All you need to do to set this up is to create the page as a **Single Contact** menu item. You can see how this item is configured in the screen shot below. 
