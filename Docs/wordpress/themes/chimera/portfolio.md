...
The **Portfolio** example page demonstrates how you can create a beautiful page with the Chimera template. Here is some information to help you replicate this page as it appears in the demo.
...
The **Portfolio** page is a regular **Page**. To recreate the layout the way it appears in our demo, enter `menu-portfolio` in the **Page Suffix** field in the **Gizmos** page inside the **Chimera** theme settings. This suffix is tied to a class in the demo.less file that sets the page up so it appears the way it does in the demo.
...
<div class="gantry-row">
    ...
    <div class="gantry-width-50">
        <div class="gantry-width-spacer">
            <span class="rt-image">
                <img src="http://demo.rockettheme.com/live/wordpress/chimera/wp-content/rockettheme/rt_chimera_wp/pages/portfolio/img-17.jpg" alt="image" />
            </span>
        </div>
    </div>
    ...
    <div class="gantry-width-50">
        <div class="gantry-width-spacer">
            ...
            <div class="clear"></div>
            <p class="largemargintop"><a href="http://www.rockettheme.com/wordpress-themes/chimera" class="readon">Learn More</a></p>
        </div>
    </div>
</div>
</div>
...
:   1. **Showcase - Text** [10%, 45%, se]
    2. **Breadcrumbs** [12%, 14%, se]
    3. **Main Top - RokSprocket** [15%, 14%, se]
    4. **Mainbody** [43%, 14%, se]
    5. **Extension - RokSprocket** [60%, 14%, se]
    6. **Bottom - Text** [70%, 14%, se]
    7. **Footer - Text** [82%, 14%, se]
...
5. [Extension - RokSprocket](portfolio.md#extension-section)
6. [Bottom - Text](portfolio.md#bottom-section)
...
![Main Top](assets/page_portfolio_3.jpeg)
...
![Extension](assets/page_portfolio_5.jpeg)
...
![Bottom](assets/page_portfolio_6.jpeg)

Here is a breakdown for the **Bottom** section:
...
<div class="gantry-row">
    ...
    <div class="gantry-width-20">
        <div class="gantry-width-spacer">
            <a href="http://www.rockettheme.com/wordpress-themes/hadron"><img class="rt-transparent-image" src="http://demo.rockettheme.com/live/wordpress/chimera/wp-content/rockettheme/rt_chimera_wp/pages/portfolio/img-18.png" alt="image" /></a>
        </div>
    </div>
    <div class="gantry-width-20">
        <div class="gantry-width-spacer">
            <a href="http://www.rockettheme.com/wordpress-themes/acacia"><img class="rt-transparent-image" src="http://demo.rockettheme.com/live/wordpress/chimera/wp-content/rockettheme/rt_chimera_wp/pages/portfolio/img-19.png" alt="image" /></a>
        </div>
    </div>
    <div class="gantry-width-20">
        <div class="gantry-width-spacer">
            <a href="http://www.rockettheme.com/wordpress-themes/corvus"><img class="rt-transparent-image" src="http://demo.rockettheme.com/live/wordpress/chimera/wp-content/rockettheme/rt_chimera_wp/pages/portfolio/img-20.png" alt="image" /></a>
        </div>
    </div>
    <div class="gantry-width-20">
        <div class="gantry-width-spacer">
            <a href="http://www.rockettheme.com/wordpress-themes/spectral"><img class="rt-transparent-image" src="http://demo.rockettheme.com/live/wordpress/chimera/wp-content/rockettheme/rt_chimera_wp/pages/portfolio/img-21.png" alt="image" /></a>
        </div>
    </div>
    <div class="gantry-width-20">
        <div class="gantry-width-spacer">
            <a href="http://www.rockettheme.com/wordpress-themes/stratos"><img class="rt-transparent-image" src="http://demo.rockettheme.com/live/wordpress/chimera/wp-content/rockettheme/rt_chimera_wp/pages/portfolio/img-22.png" alt="image" /></a>
        </div>
    </div>
</div>
</div>
...
<p><a href="http://www.rockettheme.com/wordpress-themes/chimera" class="readon">Join Now</a></p>
~~~
...
![Showcase](assets/page_portfolio_7.jpeg)
