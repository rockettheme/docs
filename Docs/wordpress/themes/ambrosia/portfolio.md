...
:   1. **Showcase - Custom HTML (Widget)** [10%, 45%, se]
    3. **Feature - Custom HTML (Widget)** [16%, 13%, se]
    4. **Mainbar - Promo Image (Particle)** [32%, 13%, se]
    4. **Plugin - Custom HTML (Widget)** [56%, 13%, se]
    5. **Bottom - Custom HTML (Widget)** [70%, 30%, se]
...
This area of the page is a **Content List** particle rendered via a **Gantry 5 Particle** widget placed in the `feature-a` position.
...
The **Mainbar** section includes six **Promo Image** particles rendered through **Gantry 5 Particle** widgets. These widgets are placed in `main-a`, `main-b`, and `main-c` widget positions. Each particle displays an image with descriptive text and animation on hover. The settings for one of these particles is listed below.
...
This area of the page is an **Info List** particle rendered via a **Gantry 5 Particle** widget placed in the `plugin-a` position.
...
<div class="g-layercontent g-layercontent-small">
  ...
  <a href="http://www.rockettheme.com/wordpress/templates/ambrosia" class="button">Join Now</a>
</div>
~~~
