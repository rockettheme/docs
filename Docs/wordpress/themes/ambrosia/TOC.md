...
* Ambrosia
    ...
    * [How to Install](../../platform/themes.md#how-to-install)
        * [Installing the Theme](../../start/themes.md#how-to-install-a-wordpress-theme)
        * [RocketLauncher (3.x)](../../start/install_wordpress_3x.md)
        * [Installing Plugins](../../start/plugins.md#how-to-install-an-plugin)
