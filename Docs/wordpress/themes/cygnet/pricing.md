...
The **Pricing Tables** example page demonstrates how you can create a beautiful page with the Cygnet theme. Here is some information to help you replicate this page as it appears in the demo.
...
<div class="gantry-row">
    ...
    <div class="gantry-width-50">
        <div class="gantry-width-spacer">
            ...
            <p><a href="http://www.rockettheme.com/wordpress-themes/cygnet" class="readon">Sign Up</a></p>
        </div>
    </div>
    <div class="gantry-width-50">
        <div class="gantry-width-spacer">
            ...
            <p class="success">Want to use Cygnet for your clients? <a href="http://www.rockettheme.com/wordpress-themes/cygnet">Purchase Single Package Now</a>.</p>
        </div>
    </div>
</div>
</div>
...
<div class="gantry-width-container">
    ...
    <ul class="rt-table">
        ...
        <li class="rt-table-cta-button"><a class="readon" href="http://www.rockettheme.com/wordpress-themes/cygnet">Sign Up</a></li>
    </ul>
</div>
...
<div class="gantry-width-spacer">
    <p>Free <strong>10 days trial</strong> on all plans. No credit card needed! Need a bigger plan? <a href="http://www.rockettheme.com/wordpress-themes/cygnet">View Professional Plan</a>.</p>
</div>
~~~
