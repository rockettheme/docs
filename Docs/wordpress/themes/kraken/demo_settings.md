---
title: Kraken: Recreating the Demo - Theme Settings
...
One of the most important aspects of any Gantry theme is its ability to be easily customized using the settings presets in the Styles tab within the Gantry 5 administrator. These settings can be adjusted by navigating to **Administration -> Kraken Theme**. To replicate the demo, the styling changes are being made in the **Styles** tab.
