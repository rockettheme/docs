---
title: Myriad: Recreating the Demo - Services Page
...
The **Services** example page demonstrates how you can create a beautiful page with the Myriad template. Here is some information to help you replicate this page as it appears in the demo.
...
The **Services** page is a regular **Page**. To recreate the layout the way it appears in our demo, enter `menu-services` in the **Page Suffix** field in the **Gizmos** page inside the **Myriad** theme settings. This suffix is tied to a class in the demo.less file that sets the page up so it appears the way it does in the demo.
...
:   1. **Showcase - Text** [9%, 45%, se]
    ...
    3. **Main Top - Text** [15%, 12%, se]
    4. **Main Top - Text** [35%, 12%, se]
    5. **Expanded Top - Text** [47%, 12%, se]
    6. **Mainbody** [58%, 12%, se]
    7. **Extension - Text** [71%, 35%, se]
    8. **Bottom - Text** [80%, 12%, se]
    9. **Bottom - Text** [80%, 52%, se]

1. [Showcase - Text](services.md#showcase-section)
2. [Breadcrumbs](services.md#breadcrumbs-section)
2. [Main Top - Text](services.md#main-top-section)
...
7. [Bottom - Text](services.md#footer-section)
8. [Bottom - Text](services.md#footer-section)
...
![Main Top](assets/page_services_3.jpg)
...
<div class="gantry-width-container">
    ...
    <img src="http://demo.rockettheme.com/live/wordpress/myriad/wp-content/rockettheme/rt_myriad_wp/pages/services/img-02.jpg" alt="image" />
    <div class="gantry-width-spacer">   
        <h4>Grid System</h4>
...
<div class="gantry-width-25">
        <img src="http://demo.rockettheme.com/live/wordpress/myriad/wp-content/rockettheme/rt_myriad_wp/pages/services/img-03.jpg" alt="image" />
    <div class="gantry-width-spacer">   
...
<div class="gantry-width-25">
    <img src="http://demo.rockettheme.com/live/wordpress/myriad/wp-content/rockettheme/rt_myriad_wp/pages/services/img-04.jpg" alt="image" />
    <div class="gantry-width-spacer">   
...
<div class="gantry-width-25">
    <img src="http://demo.rockettheme.com/live/wordpress/myriad/wp-content/rockettheme/rt_myriad_wp/pages/services/img-05.jpg" alt="image" />
    <div class="gantry-width-spacer">   
...
* Set the **Widget Variations** option to **Box 3, No Padding all**.
* Leaving everything else at its default setting, select **Save**.
...
<div class="gantry-row">
    ...
    <div class="gantry-width-50">
        <div class="gantry-width-spacer">
            <span class="rt-image"><img src="http://demo.rockettheme.com/live/wordpress/myriad/wp-content/rockettheme/rt_myriad_wp/pages/services/img-01.jpg" alt="image" /></span>
        </div>
    </div>  
</div>
</div>
...
* Set the **Widget Variations** option to **No Margin All**.
...
<p><a href="www.rockettheme.com/wordpress-themes/myriad" class="readon">Purchase Myriad</a></p>
~~~
