...
<div class="gantry-row">
    ...
    <div class="gantry-width-50">
        <div class="gantry-width-spacer">
            ...
            <p><a href="http://www.rockettheme.com/wordpress-themes/iridescent" class="readon">Sign Up</a></p>
        </div>
    </div>
    <div class="gantry-width-50">
        <div class="gantry-width-spacer">
            ...
            <p class="success">Want to use Iridescent for your clients? <a href="http://www.rockettheme.com/wordpress-themes/iridescent">Purchase Single Package Now</a>.</p>
        </div>
    </div>
</div>
</div>
...
<div class="gantry-width-container">
    ...
    <ul class="rt-table">
        ...
        <li class="rt-table-cta-button"><a class="readon" href="http://www.rockettheme.com/wordpress-themes/iridescent">Sign Up</a></li>
    </ul>
</div>
...
<div class="gantry-width-spacer">
    <p>Free <strong>10 days trial</strong> on all plans. No credit card needed! Need a bigger plan? <a href="http://www.rockettheme.com/wordpress-themes/iridescent">View Professional Plan</a>.</p>
</div>
~~~
