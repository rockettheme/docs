...
## Is Photon compatible for WordPress 1.5 or 2.5?

No, Photon is only compatible with WordPress 3.4+.
...
[RokSprocket][roksprocket] is a powerful content display widget for WordPress 3.x. It was designed as the successor to our legacy content widgets: RokStories, RokTabs, RokNewsPager, RokNewsflash, RokMicronews, and basically any widget in the RT arsenal that manipulates and displays articles.
...
[forum]: http://www.rockettheme.com/forum/wordpress-theme-photon
