...
:   1. **Navigation** Logo (Particle) [2%, 39%, se]
    2. **Navigation** Menu (Particle) [6%, 4%, se]
    3. **Navigation** Social (Particle) [6%, 73%, se]
    4. **Navigation** Search (Particle) [6%, 95%, se]
    5. **Showcase** Slider (Particle) [10%, 35%, se]
    6. **Utility** Custom HTML (Particle) [25%, 50%, se]    
    7. **Feature** Custom HTML (Particle) [36%, 5% se]
    8. **Feature** Strips Slider (Particle) [38%, 90% se]
    ...
    14. **Copyright** Branding (Particle) [92%, 50%, se]
    15. **Copyright** Copyright (Particle) [99%, 50%, se]
