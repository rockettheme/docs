---
title: Phoenix: Latest News Particle
...
| Date               | Choose between showing the **Published** or **Modified** date. You can also **Hide** the date. |
| Date Format        | Select the format you want the date to display in.                                             |
...
| Target             | Choose which window/tab the link opens to.                                                     |