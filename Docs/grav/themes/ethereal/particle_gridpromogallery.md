---
title: Ethereal: Grid Promo Gallery Particle
...
![](assets/particle_gridpromo1.jpeg)

The **Grid Promo Gallery** particle enables you to display animated, well-organized numbers and statistics on your site.
...
![](assets/particle_gridpromo2.jpeg)
...
![](assets/particle_gridpromo3.jpeg)

| Option      | Description                                                                             |
| :-----      | :-----                                                                                  |
| Item Name   | Enter the name you would like to assign to the item. This only appears in the back end. |
| CSS Classes | Set the number you would like to have displayed in the item.                            |
| Image       | Select the icon to be displayed                                                         |
| Tag         | Add text to describe your statistic item.                                               |
| Title       | Enter a title.                                                                          |
