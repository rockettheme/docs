---
title: Isotope: Owl Carousel Particle
...
Owl Carousel features four layouts, three of which are used in Isotope's demo. You will see examples of these layouts below.
...
The settings panel for **Owl Carousel** is filled with options, bells, and whistles you can use to configure your particle. Here is a quick breakdown of the settings you will find in this particle in Isotope.
