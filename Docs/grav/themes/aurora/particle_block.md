---
title: Aurora: Block Content Particle
...
>> NOTE: The CSS class `g-blockcontent-spacing` is used in our demo to create spacing. If you are unhappy with the look of your particle, try this class.
