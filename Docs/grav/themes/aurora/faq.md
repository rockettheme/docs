...
I installed the Aurora RocketLauncher but the images are different with the demo site.
-----
...
Aurora is extremely versatile, and you can switch between the standard layout (featured in our demo and RocketLauncher by default) or a Full Width one that hugs the edges of your browser. To do so, simply do the following:
