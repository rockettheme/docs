---
title: Zenith: Testimonials Particle
...
| Pages              | Select the number of posts you would like the particle to fetch.                             |
...
| Text Type       | Choose between showing the **Introduction** or **Full Text** text to display. You can also **Hide** text.                                                |
