...
:   1. **Navigation** Logo (Particle) [1%, 12%, se]
    ...
    7. **Mainbody** Block Content (Particle) [34%, 61%, se]
    8. **Mainbody** Content Tabs (Particle) [44%, 61%, se]
    9. **Mainbody** Headlines (Particle) [74%, 61%, se]
    10. **Mainbody** Custom HTML (Particle) [78%, 61%, se]
    11. **Expandedbottom** Vertical Menu (Particle) [25%, 50%, se] 
    12. **Expandedbottom** Custom HTML (Particle) [25%, 50%, se] 
    13. **Footer A** Custom HTML (Particle) [90%, 35%, se]
    14. **Footer B** Custom HTML (Particle) [90%, 67%, se]
    15. **Footer B** MailChimp (Particle) [95%, 67%, se]
...
The front page of the Lexicon demo sits apart from the rest of the page layouts in that it features the latest and greatest features of the theme. It is because of this that several layout overrides were done. In this section, we will break down the settings you will need to recreate elements present in the front page of the Lexicon demo.
...
Lexicon has its own built-in Menu Editor which takes full advantage of Grav's menu system, taking your Grav menus and enhancing them before passing them to visitors on the front end. Any changes made in the Menu Editor will only affect the way it appears to the visitor, and not the way Grav sees or uses it.
