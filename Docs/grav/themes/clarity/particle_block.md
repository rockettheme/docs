---
title: Clarity: Block Content Particle
...
| Category        | **Show** or **Hide** the page's category.                                                                                                                |
| Article Text    | Choose between showing the **Introduction** or **Full Article** content text to display. You can also **Hide** text.                                     |
