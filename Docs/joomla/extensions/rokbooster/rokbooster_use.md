...
>> NOTE: Using wildcards (/folder/*.*) is possible in the **Ignored Files** setting. This should be used carefully and tested thoroughly before taking these changes live.
