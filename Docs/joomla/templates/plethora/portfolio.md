...
The **Portfolio** example page demonstrates how you can create a clean, functional portfolio with the Plethora template. Here is some information to help you replicate this page as it appears in the demo.
...
<div class="gantry-row">
    ...
    <div class="gantry-width-50">
        <div class="gantry-width-spacer">
            ...
            <div class="clear"></div>
            <p class="largemargintop"><a href="http://www.rockettheme.com/joomla/templates/plethora" class="readon">Learn More</a></p>
        </div>
    </div>
</div>
<div class="clear"></div>
...
<p><a href="http://www.rockettheme.com/joomla/templates/plethora" class="readon">Join Now</a></p>
~~~
