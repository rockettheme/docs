...
The **Pricing Tables** example page demonstrates how you can create a beautiful page with the Plethora template. Here is some information to help you replicate this page as it appears in the demo.
...
<div class="gantry-row">
    <div class="gantry-width-50">
        <div class="gantry-width-spacer">
            ...
            <p><a href="http://www.rockettheme.com/joomla/templates/plethora" class="readon">Sign Up</a></p>
        </div>
    </div>
    <div class="gantry-width-50">
        <div class="gantry-width-spacer">
            ...
            <p class="success">Want to use Plethora for your clients? <a href="http://www.rockettheme.com/joomla/templates/plethora">Purchase Single Package Now</a>.</p>
        </div>
    </div>
</div>
<div class="clear"></div>
...
:   1. **Custom HTML - Pricing** [12%, 45%, se]
    2. **Article Content** [20%, 9%, se]
    3. **Custom HTML - Try it Out for 10 Days Free** [35%, 9%, se]
    4. **Custom HTML - No Hidden Fee** [65%, 9%, se]
    5. **Custom HTML - Plethora Demo** [75%, 9%, se]
...
5. [Custom HTML - Plethora Demo](pricing.md#custom-html---plethora-demo)
...
<div class="gantry-width-25">
    <ul class="rt-table">
        ...
        <li class="rt-table-cta-button"><a class="readon" href="http://www.rockettheme.com/joomla/templates/plethora">Sign Up</a></li>
    </ul>
</div>
<div class="gantry-width-25">
    <ul class="rt-table">
...
<div class="clear"></div>
<div class="gantry-width-spacer">
    <p>Free <strong>10 days trial</strong> on all plans. No credit card needed! Need a bigger plan? <a href="http://www.rockettheme.com/joomla/templates/plethora">View Professional Plan</a>.</p>
</div>
~~~
...
<p><a href="http://www.rockettheme.com/joomla/templates/plethora" class="readon largemargintop">Sign Up</a></p>
~~~
