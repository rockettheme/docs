...
* Mercado
    ...
    * [Recreate the Demo](demo.md)
        ...
        * [Module Settings](demo.md#module-settings)
            ...
            * [Demo Cart](demo_module_2.md)
            * [Welcome](demo_module_3.md)
            * [Login Form](demo_module_4.md)
            * [Featured Products](demo_module_5.md)
            * [Main Top A](demo_module_6.md)
            * [Product Details](demo_module_7.md)
            * [Product Overview](demo_module_8.md)
            * [Gantry Framework](demo_module_9.md)
            * [New Sidepanel Layout](demo_module_10.md)
            * [9 Preset Styles](demo_module_11.md)
            * [Connect With Us](demo_module_12.md)
            * [Product Quick List](demo_module_13.md)
            * [Disclaimer](demo_module_14.md)
    * [FAQ](faq.md)
