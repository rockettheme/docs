...
:   1. **Navigation** Logo (Particle) [1%, 8%, se]
    2. **Navigation** Social (Particle) [1%, 25%, se]
    3. **Navigation** Menu (Particle) [1%, 85%, se]
    4. **Header** Custom HTML (Particle) [5%, 8%, se]
    5. **Header** Custom HTML (Particle) [25%, 8%, se]
    6. **Slideshow** Owl Carousel (Particle) [25%, 65% se]
    8. **Above** Simple Content (Particle) [38%, 8%, se]
    8. **Above** Simple Content (Particle) [38%, 65%, se]
    9. **Feature** Owl Carousel (Particle) [44%, 65%, se]
    10. **Expanded** Simple Content (Particle) [59%, 8%, se]
    11. **Expanded** Image Grid (Particle) [59%, 65%, se]
    12. **Extension** Simple Content (Particle) [70%, 66%, se]
    13. **Extension** Block Content (Particle) [81%, 8%, se]
    14. **Bottom** Pricing Table (Particle) [93%, 8%, se]
    15. **Footer** Custom HTML (Particle) [93%, 60%, se]
    16. **Footer** Newsletter (Particle) [96%, 8%, se]
    17. **Copyright** Copyright (Particle) [96%, 60%, se]
