---
title: Akuatik: Photo Collage Particle
...
>> Note: When using Joomla Content source, images can utilize **Width** and **Height** options by adding, for example, **width-2** and/or **height-2** to the **Alt Text** field for either the Intro or Full image of the Article(s) you are displaying.
