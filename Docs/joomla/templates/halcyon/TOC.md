...
details: http://www.rockettheme.com/joomla/templates/halcyon/
demo: http://demo.rockettheme.com/joomla-templates/halcyon/
download: http://www.rockettheme.com/joomla/templates/halcyon/modal/downloads
support: http://www.rockettheme.com/forum/joomla-template-halcyon/
...
* Halcyon
    ...
    * [Recreate the Demo](demo.md)
        ...
        * [Module Settings](demo.md#module-settings)
            ...
            * [Sample Cart](demo_module_2.md)
            * [RokAjaxSearch](demo_module_3.md)
            * [FP Showcase A](demo_module_4.md)
            * [FP Feature A](demo_module_5.md)
            * [Top Sellers](demo_module_6.md)
            * [Individual Module Styling](demo_module_7.md)
            * [Other Menu Options](demo_module_8.md)
            * [Tutorials](demo_module_9.md)
            * [Promotion](demo_module_10.md)
            * [FP Bottom A](demo_module_11.md)
            * [Demo Information](demo_module_12.md)
            * [FP Footer A](demo_module_13.md)
