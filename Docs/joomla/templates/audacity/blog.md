...
:   1. **Custom HTML - Blog** [8%, 45%, se]
    2. **Breadcrumbs** [10%, 16%, se]
    3. **RokAjaxSearch - Search the Blog** [12%, 83%, sw]
    4. **Menu Module - Site Menu** [17%, 83%, sw]
    5. **Custom HTML - Template Tutorials** [45%, 83%, sw]
    6. **Login Form - Login Form** [55%, 83%, sw]
    7. **Who's Online - Who's Online** [67%, 83%, sw]
    8. **Custom HTML - Join Our Newsletter** [78%, 42%, se]
    9. **Custom HTML - Audacity Demo** [84%, 16%, se]
    10. **Custom HTML - Sample Contact Info** [84%, 50%, se]
...
9. [Custom HTML - Audacity Demo](blog.md#custom-html---audacity-demo)
...
<ul>
    ...
    <li><a href="http://www.rockettheme.com/docs/joomla/templates/audacity/demo.md">Recreating the Demo</a></li>
</ul>
~~~
