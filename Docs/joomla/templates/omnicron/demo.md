...
Like any Gantry template, Omnicron allows you to assign modules to specific positions within selected overrides. This makes it possible to not only utilize the full power of the Gantry framework, but to make each area of your site uniquely suited to meet your user's needs.
...
1. [Client Testimonial][module1]
2. [System Requirements][module2]
3. [Service Updates][module3]
...
[Omnicron]: assets/omnicron2.jpeg
[Omnicron2]: assets/omnicron.jpeg
