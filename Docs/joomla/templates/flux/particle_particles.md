...
The **Top** and **Slideshow** are where you would want to place this particle in Flux if you wish to display the animation throughout the whole page by disabling the **Section Only** option.