...
**The Team** example page demonstrates how you can create a rich team page with the Nuance template. Here is some information to help you replicate this page as it appears in the demo.
...
:   1. **Custom HTML - The Team** [9%, 43%, se]
    2. **Article Content** [15%, 14%, se]
    3. **Custom HTML - Management Team** [23%, 14%, se]
    4. **Custom HTML - Core Developers** [50%, 14%, se]
    5. **Custom HTML - Support Assistants** [62%, 14%, se]
    6. **Custom HTML - We Are Hiring** [74%, 40%, se]
    7. **Custom HTML - Nuance Demo** [80%, 14%, se]
    8. **Custom HTML - Sample Contact Info** [80%, 51%, se]

1. [Custom HTML - The Team](theteam.md#custom-html---the-team)
2. [Article Content](theteam.md#mainbody)
...
7. [Custom HTML - Nuance Demo](theteam.md#custom-html---nuance-demo)
8. [Custom HTML - Sample Contact Info](theteam.md#custom-html---sample-contact-info)
...
| Option      | Setting                                                                   |
| :---------- | :-----------                                                              |
| Title       | `The Team[span class="rt-title-tag"]Meet the People Behind Nuance[/span]` |
| Show Title  | Yes                                                                       |
| Position    | showcase-a                                                                |
| Status      | Published                                                                 |
| Access      | Public                                                                    |
...
<p><a href="http://www.rockettheme.com/joomla/templates/nuance" class="readon largemargintop">Join Nuance</a></p>
~~~
