    ...
    <div class="gantry-width-container">
        <div class="gantry-width-50">
            <div class="gantry-width-spacer">
                ...
                <p><a href="http://www.rockettheme.com/joomla/templates/nuance" class="readon">Sign Up</a></p>
            </div>
        </div>
        <div class="gantry-width-50">
            <div class="gantry-width-spacer">
                ...
                <p class="success">Want to use Nuance for your clients? <a href="http://www.rockettheme.com/joomla/templates/nuance">Purchase Single Package Now</a>.</p>
            </div>
        </div>
    </div>
</div>
...
5. [Custom HTML - Nuance Demo](pricing.md#custom-html---nuance-demo)
...
<div class="gantry-width-container">
    <div class="gantry-width-25">
        <ul class="rt-table">
            ...
            <li class="rt-table-cta-button"><a class="readon" href="http://www.rockettheme.com/joomla/templates/nuance">Sign Up</a></li>
        </ul>
    </div>
...
<div class="gantry-width-spacer">
    <p>Free <strong>10 days trial</strong> on all plans. No credit card needed! Need a bigger plan? <a href="http://www.rockettheme.com/joomla/templates/nuance">View Professional Plan</a>.</p>
</div>
~~~
...
<p><a href="http://www.rockettheme.com/joomla/templates/nuance" class="readon largemargintop">Sign Up</a></p>
~~~
