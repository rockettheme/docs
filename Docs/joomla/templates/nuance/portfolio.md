...
The **Portfolio** example page demonstrates how you can create a clean, functional portfolio with the Nuance template. Here is some information to help you replicate this page as it appears in the demo.
    ...
    <div class="gantry-width-container">
        ...
        <div class="gantry-width-50">
            <div class="gantry-width-spacer">
                ...
                <div class="clear"></div>
                <p class="largemargintop"><a href="http://www.rockettheme.com/joomla/templates/nuance" class="readon">Learn More</a></p>
            </div>
        </div>
    </div>
</div>
...
:   1. **Custom HTML - Portfolio** [10%, 45%, se]
    2. **RokSprocket Mosaic** [15%, 15%, se]
    3. **RokSprocket Strips - What Our Clients Say** [47%, 15%, se]
    4. **Custom HTML - Our Satisfied Clients** [70%, 15%, se]
    5. **Custom HTML - Nuance Demo** [80%, 15%, se]
    6. **Custom HTML - Sample Contact Info** [80%, 52%, se]
    7. **Article Content** [55%, 15%, se]
...
5. [Custom HTML - Nuance Demo](portfolio.md#custom-html---nuance-demo)
...
<p><a href="http://www.rockettheme.com/joomla/templates/nuance" class="readon">Join Now</a></p>
~~~
