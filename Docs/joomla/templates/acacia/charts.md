...
Here is the code related to the Progressive Knob found on the far left in the image above. If you are entering this into an article, you will want to make sure you are either using RokPad or another non-WYSIWYG editor.
