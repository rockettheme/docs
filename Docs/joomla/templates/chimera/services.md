...
The **Services** example page demonstrates how you can create a content rich page with the Chimera template. Here is some information to help you replicate this page as it appears in the demo.
...
:   1. **Custom HTML - Services** [10%, 45%, se]
    ...
    3. **Custom HTML - Services: Chart JS** [17%, 13%, se]
    4. **Custom HTML - Our Core Service** [35%, 13%, se]
    5. **Article Content** [49%, 13%, se]
    6. **Custom HTML - Grid System** [58%, 13%, se]
    7. **Custom HTML - Save Your Time and Effort** [71%, 33%, se]
    8. **Custom HTML - Chimera Demo** [80%, 13%, se]
...
8. [Custom HTML - Chimera Demo](services.md#custom-html---chimera-demo)
...
<p><a href="http://www.rockettheme.com/joomla/templates/chimera" class="readon largemargintop">Purchase Chimera</a></p>
~~~
...
[servicespage9]: assets/page_aboutus_8.jpeg
[servicespage10]: assets/page_aboutus_9.jpeg
