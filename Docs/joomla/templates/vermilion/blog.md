---
title: Vermilion: Recreating the Demo - Blog Page
...
The **Blog** example page demonstrates how you can create a beautiful page with the Vermilion template. Here is some information to help you replicate this page as it appears in the demo.
...
:   1. **Custom HTML - Blog** [9%, 45%, se]
    ...
    3. **RokAjaxSearch - Search the Blog** [15%, 81%, sw]
    4. **Menu Module - Site Menu** [20%, 81%, sw]
    5. **Custom HTML - Template Tutorials** [47%, 81%, sw]
    6. **Login Form - Login Form** [57%, 81%, sw]
    7. **Who's Online - Who's Online** [70%, 81%, sw]
    8. **Custom HTML - Join Our Newsletter** [78%, 45%, se]
    9. **Custom HTML - Vermilion Demo** [84%, 19%, se]
    10. **Custom HTML - Sample Contact Info** [84%, 52%, se]
...
9. [Custom HTML - Vermilion Demo](blog.md#custom-html---vermilion-demo)
...
<ul>
    ...
    <li><a href="http://www.rockettheme.com/docs/joomla/templates/vermilion/demo.md">Recreating the Demo</a></li>
</ul>
~~~
