...
One of the most important aspects of any Gantry template is its ability to be easily customized using the settings presets in the Styles tab within the Gantry 5 administrator. These settings can be adjusted by navigating to **Administration -> Vermilion Template**. To replicate the demo, the styling changes are being made in the **Styles** tab.
