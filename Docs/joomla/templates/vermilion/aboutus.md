---
title: Vermilion: Recreating the Demo - About Us Page
...
:   1. **Custom HTML - About Us** [12%, 45%, se]
    ...
    3. **Custom HTML - About Us: Introduction** [22%, 16%, se]
    4. **Article Content** [37%, 16%, se]
    5. **Custom HTML - Our Mission** [50%, 16%, se]
    6. **Custom HTML - We Always Try to Create a Difference** [68%, 35%, se]
    7. **Custom HTML - Vermilion Demo** [80%, 16%, se]
...
7. [Custom HTML - Vermilion Demo](aboutus.md#custom-html---vermilion-demo)
...
| Option      | Setting                                                          |
| :---------- | :-----------                                                     |
| Title       | `About Us[span class="rt-title-tag"]Welcome to Vermilion[/span]` |
| Show Title  | Yes                                                              |
| Position    | top-a                                                            |
| Status      | Published                                                        |
| Access      | Public                                                           |
