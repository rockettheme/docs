...
**The Team** example page demonstrates how you can create a rich team page with the Sirocco template. Here is some information to help you replicate this page as it appears in the demo.
...
:   1. **Custom HTML - The Team** [9%, 43%, se]
    ...
    3. **Custom HTML - Core Developers** [17%, 16%, se]
    4. **Custom HTML - Management Team** [28%, 16%, se]
    5. **Custom HTML - Support Assistants** [55%, 16%, se]
    6. **Article Content** [65%, 16%, se]
    7. **Custom HTML - We Are Hiring** [75%, 40%, se]
    8. **Custom HTML - Sirocco Demo** [81%, 16%, se]
...
6. [Article Content](theteam.md#mainbody)
7. [Custom HTML - We Are Hiring](theteam.md#custom-html---we-are-hiring)
8. [Custom HTML - Sirocco Demo](theteam.md#custom-html---sirocco-demo)
...
<p><a href="http://www.rockettheme.com/joomla/templates/sirocco" class="readon largemargintop">Join Sirocco</a></p>
~~~
...
<p><a href="http://www.rockettheme.com/joomla/templates/sirocco" class="readon">Learn More</a></p>
~~~
