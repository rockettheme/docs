---
title: Sirocco: How to Customize the 404 Page
description: Your Guide to the Sirocco Template for Joomla
...
Rather than displaying a jarring, simple black-and-white page with a giant 404 scrawled across it, we've designed a 404 error page that fits the Sirocco template as seamlessly as possible. It also gives your visitors the ability to navigate to other areas of your site within the 404 page itself.
...
Begin by visiting the **rt_sirocco/error.php** file within the primary Sirocco template folder where you will find language constants such as: 

~~~ .html
RT_ERROR_TITLE, RT_ERROR_MESSAGE, RT_ERROR_HOME
~~~

These constants are defined in **rt_sirocco/language/en-GB/en-GB.tpl_rt_sirocco.ini**. For example:
