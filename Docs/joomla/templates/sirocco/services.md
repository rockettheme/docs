...
The **Services** example page demonstrates how you can create a content rich page with the Sirocco template. Here is some information to help you replicate this page as it appears in the demo.
...
:   1. **Custom HTML - Services** [10%, 45%, se]
    ...
    6. **Article Content** [60%, 13%, se]
    7. **Custom HTML - Save Your Time and Effort** [72%, 33%, se]
    8. **Custom HTML - Sirocco Demo** [79%, 13%, se]
    9. **Custom HTML - Sample Contact Info** [79%, 52%, se]
...
8. [Custom HTML - Sirocco Demo](services.md#custom-html---sirocco-demo)
...
<p><a href="http://www.rockettheme.com/joomla/templates/sirocco" class="readon largemargintop">Purchase Sirocco</a></p>
~~~
