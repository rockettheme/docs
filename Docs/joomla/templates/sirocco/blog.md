...
The **Blog** example page demonstrates how you can create a beautiful page with the Sirocco template. Here is some information to help you replicate this page as it appears in the demo.
...
9. [Custom HTML - Sirocco Demo](blog.md#custom-html---sirocco-demo)
...
<ul>
    ...
    <li><a href="http://www.rockettheme.com/docs/joomla/templates/sirocco/demo.md">Recreating the Demo</a></li>
</ul>
~~~
