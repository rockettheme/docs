...
description: Your Guide to Using the Anacron (Gantry 4 Edition) Template for Joomla
...
>> NOTE: Gantry v4.1.35 is required for Anacron to work correctly. For more details on the Gantry Framework, please visit its [dedicated website](http://gantry.org).
