...
**The Team** example page demonstrates how you can create a rich team page with the Iridescent template. Here is some information to help you replicate this page as it appears in the demo.
...
![Page](assets/page_theteam.jpeg)

:   1. **Custom HTML - The Team** [8%, 43%, se]
    2. **Breadcrumbs** [11%, 13%, se]
    3. **Custom HTML - Core Developers** [14%, 13%, se]
    4. **Custom HTML - Management Team** [26%, 13%, se]
    5. **Article Content** [53%, 13%, se]
    6. **Custom HTML - Support Assistants** [62%, 13%, se]
    7. **Custom HTML - We Are Hiring** [74%, 40%, se]
    8. **Custom HTML - Iridescent Demo** [80%, 13%, se]
    9. **Custom HTML - Sample Contact Info** [80%, 51%, se]
...
8. [Custom HTML - Iridescent Demo](theteam.md#custom-html---iridescent-demo)
...
<p><a href="http://www.rockettheme.com/joomla/templates/iridescent" class="readon largemargintop">Join Iridescent</a></p>
~~~
