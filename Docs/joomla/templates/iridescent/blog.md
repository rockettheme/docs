---
title: Iridescent: Recreating the Demo - Blog Page
...
The **Blog** example page demonstrates how you can create a beautiful page with the Iridescent template. Here is some information to help you replicate this page as it appears in the demo.
...
:   1. **Custom HTML - Blog** [8%, 45%, se]
    ...
    3. **RokAjaxSearch - Search the Blog** [13%, 86%, sw]
    4. **Menu Module - Site Menu** [18%, 86%, sw]
    5. **Custom HTML - Template Tutorials** [45%, 86%, sw]
    6. **Login Form - Login Form** [55%, 86%, sw]
    7. **Who's Online - Who's Online** [67%, 86%, sw]
    8. **Custom HTML - Join Our Newsletter** [76%, 42%, se]
    9. **Custom HTML - Iridescent Demo** [82%, 15%, se]
    10. **Custom HTML - Sample Contact Info** [82%, 50%, se]
...
9. [Custom HTML - Iridescent Demo](blog.md#custom-html---iridescent-demo)
...
<ul>
    ...
    <li><a href="http://www.rockettheme.com/docs/joomla/templates/iridescent/demo.md">Recreating the Demo</a></li>
</ul>
~~~
