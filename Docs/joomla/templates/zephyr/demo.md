...
Like any Gantry template, Zephyr allows you to assign modules to specific positions within selected overrides. This makes it possible to not only utilize the full power of the Gantry framework, but to make each area of your site uniquely suited to meet your user's needs.
...
It would be a good idea for organization to name this override something like **Zephyr - Home** as it would be used only for the front page of your site.
