...
**The Team** example page demonstrates how you can create a rich team page with the Cygnet template. Here is some information to help you replicate this page as it appears in the demo.
...
:   1. **Custom HTML - The Team** [9%, 43%, se]
    ...
    6. **Article Content** [67%, 16%, se]
    7. **Custom HTML - We Are Hiring** [75%, 40%, se]
    8. **Custom HTML - Cygnet Demo** [81%, 16%, se]
...
8. [Custom HTML - Cygnet Demo](theteam.md#custom-html---cygnet-demo)
...
<p><a href="http://www.rockettheme.com/joomla/templates/cygnet" class="readon largemargintop">Join Cygnet</a></p>
~~~
