...
:   1. **Navigation Left** Social (Particle) [1%, 7%, se]
    ...
    5. **Header Main**  (Particle) [5%, 68%, se]
    6. **Header Main**  (Particle) [11%, 5% se]
    8. **Showcase Main**  (Particle) [30%, 43%, se]
    8. **Showcase Main**  (Particle) [30%, 68%, se]
    9. **Slideshow Main**  (Particle) [40%, 5%, se]
    10. **Feature Main**  (Particle) [52%, 5%, se]
