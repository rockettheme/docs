---
title: Topaz: Info List Particle
...
Info list particles generally host most of the important content in its items, with the ability to set a title, introductory paragraph, and configure the number of columns that appear at the particle level.

### Particle Content

![](assets/particle_info1.jpg)

:   1. **Item - Name** [25%, 10%, se]
    2. **Item - Icon** [15%, 15%, se]
    3. **Item - Description** [33%, 5%, se]
