...
~~~ .html
<h3>Ricochet, the Powerful Template</h3>
...
:   1. **Custom HTML - About Us** [10%, 45%, se]
    ...
    3. **Custom HTML - About Us: Introduction** [22%, 13%, se]
    4. **Custom HTML - Our Mission** [36%, 13%, se]
    5. **Custom HTML - We Always Try to Create a Difference** [55%, 28%, se]
    6. **Article Content** [62%, 13%, se]
    7. **Custom HTML - Ricochet Demo** [74%, 13%, se]
    8. **Custom HTML - Sample Contact Info** [74%, 51%, se]
...
6. [Article Content](aboutus.md#mainbody)
7. [Custom HTML - Ricochet Demo](aboutus.md#custom-html---ricochet-demo)
...
|   Option   |                             Setting                             |
| :--------- | :-------------------------------------------------------------- |
| Title      | `About Us[span class="rt-title-tag"]Welcome to Ricochet[/span]` |
| Show Title | Yes                                                             |
| Position   | feature-a                                                       |
| Status     | Published                                                       |
| Access     | Public                                                          |
...
|        Option       |           Setting           |
| :------------------ | :-------------------------- |
| Module Class Suffix | `rt-title-center rt-square` |
...
<p><a href="http://www.rockettheme.com/joomla/templates/ricochet" class="readon largemargintop">Download Ricochet</a></p>
~~~
