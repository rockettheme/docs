---
title: Ricochet: Recreating the Demo - Contact Us Page
...
The **Contact Us** example page demonstrates how you can create a clean, functional contact page with the Ricochet template. Here is some information to help you replicate this page as it appears in the demo.

Menu Item Options
-----

![](assets/page_contactus_menu.jpeg)
...
:   1. **Custom HTML - Contact Us** [11%, 45%, se]
    ...
    3. **Custom HTML - Contact Info** [32%, 64%, se]
    4. **Custom HTML - Got Billing and Payments Questions?** [23%, 35%, se]
    5. **Custom HTML - Ricochet Demo** [73%, 12%, se]
...
5. [Custom HTML - Ricochet Demo](contactus.md#custom-html---ricochet-demo)
...
<p>Ricochet is only available as part of the Club Subscription.<span class="hidden-tablet"> Please use the RocketLauncher to install an equivalent of the demo onto your site.</span></p>
...
<h4>Email</h4>
<p>
    <span>noreply@ricochet-theme.com</span><br />
    <span>noperson@ricochet-theme.com</span>
</p>
...
<p>
    <span>Skype ID: ricochet.theme</span><br />
...
<p><a href="http://www.rockettheme.com/forum/joomla-template-ricochet" class="readon largemargintop">Send Email</a></p>
~~~
