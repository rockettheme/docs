...
Like any Gantry template, Quantive allows you to assign modules to specific positions within selected overrides. This makes it possible to not only utilize the full power of the Gantry framework, but to make each area of your site uniquely suited to meet your user's needs.
...
:   1. **Custom HTML - Built with Gantry**  [29%, 16%, se]
    ...
    3. **Mainbody** [47%, 16%, se]
    4. **RokNavMenu - Main Menu** [47%, 69%, se]
...
3. [Mainbody][module3]
4. [RokNavMenu - Main Menu][module4]
