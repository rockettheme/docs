---
title: Quantive: Recreating the Demo - RocketLauncher
...
~~~
<p>RocketLauncher is a custom Joomla package that will install the demo onto your site. Demo images are replaced with sample images to avoid any copyright issue.</p>
~~~
