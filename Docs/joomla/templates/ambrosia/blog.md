...
:   1. **Showcase - Custom HTML (Module)** [8%, 45%, se]
    ...
    3. **Aside - RokAjaxSearch (Module)** [13%, 67%, se]
    4. **Aside - Custom HTML (Module)** [15%, 67%, se]
    5. **Aside - Login (Module)** [22%, 67%, se]
    6. **Aside - Who's Online (Module)** [28%, 67%, se]
    7. **Bottom - Custom HTML (Module)** [78%, 35%, se]
...
<div class="g-layercontent">
    ...
    <a href="http://www.rockettheme.com/joomla/templates/ambrosia" class="button button-2">Submit Article</a>
</div>
~~~
