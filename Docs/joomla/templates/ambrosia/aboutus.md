...
:   1. **Showcase - Custom HTML (Module)** [11%, 45%, se]
    2. **Feature - Custom HTML (Module)** [18%, 10%, se]
    3. **Mainbar - Page Content** [32%, 10%, se]
    4. **Extension - Custom HTML (Module)** [52%, 10%, se]
    5. **Bottom - Custom HTML (Module)** [65%, 10%, se]
...
<div class="g-layercontent">
  ...
  <a href="http://www.rockettheme.com/joomla/templates/ambrosia" class="button">Download Ambrosia</a>
</div>
~~~
