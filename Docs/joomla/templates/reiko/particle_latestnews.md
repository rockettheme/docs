...
>> Note: When using Joomla Content source, images can utilize **Photo** and **Photo Large** layouts by adding **photo** or **photo-large** to the **Alt Text** field in either the Intro or Full image of the Article(s) you are displaying.
