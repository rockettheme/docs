...
:   1. **Showcase - Custom HTML (Module)** [9%, 45%, se]
    ...
    3. **Feature - Custom HTML (Module)** [29%, 15%, se]
    4. **Extension - Custom HTML (Module)** [52%, 15%, se]
    5. **Bottom - Custom HTML (Module)** [68%, 35%, se]
    6. **Footer - Custom HTML (Module)** [78%, 15%, se]
    7. **Footer - Custom HTML (Module)** [78%, 38%, se]
    8. **Footer - Custom HTML (Module)** [78%, 65%, se]
...
<div class="g-layercontent g-layercontent-small">
    ...
    <a href="http://www.rockettheme.com/joomla/templates/ethereal" class="button button-2">Join Now</a>
</div>
~~~
