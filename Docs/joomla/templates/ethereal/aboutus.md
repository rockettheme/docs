...
The **About Us** example page demonstrates how you can create a beautiful page with the Ethereal template. Here is some information to help you replicate this page as it appears in the demo.
...
:   1. **Showcase - Custom HTML (Module)** [11%, 45%, se]
    ...
    4. **Bottom - Custom HTML (Module)** [47%, 10%, se]
