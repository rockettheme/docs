...
:   1. **Showcase - Custom HTML (Module)** [8%, 40%, se]
    2. **Feature - Custom HTML (Module)** [15%, 15% se]
    3. **Mainbar - Page Content** [25%, 15%, se]
    4. **Extension - Custom HTML (Module)** [40%, 15%, se]
    5. **Bottom - Custom HTML (Module)** [65%, 35%, se]
    6. **Footer - Custom HTML (Module)** [75%, 15%, se]
    7. **Footer - Custom HTML (Module)** [75%, 38%, se]
    8. **Footer - Custom HTML (Module)** [75%, 65%, se]
