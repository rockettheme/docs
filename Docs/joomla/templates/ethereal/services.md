...
:   1. **Showcase - Custom HTML (Module)** [11%, 45%, se]
    2. **Feature - Custom HTML (Module)** [17%, 15%, se]
    3. **Mainbar - Page Content** [31%, 15%, se]
    4. **Extension - Custom HTML (Module)** [46%, 15%, se]
    5. **Bottom - Custom HTML (Module)** [60%, 40%, se]
    6. **Footer - Custom HTML (Module)** [72%, 10%, se]
    7. **Footer - Custom HTML (Module)** [72%, 38%, se]
    8. **Footer - Custom HTML (Module)** [72%, 65%, se]
