...
~~~ .html
<h3>Myriad, the Powerful Template</h3>
...
:   1. **Custom HTML - About Us** [10%, 45%, se]
    2. **Breadcrumbs** [15%, 11%, se]
    3. **Custom HTML - About Us: Introduction** [20%, 11%, se]
    4. **Article Content** [34%, 11%, se]
    5. **Custom HTML - Our Mission** [49%, 11%, se]
    6. **Custom HTML - We Always Try to Create a Difference** [68%, 28%, se]
    7. **Custom HTML - Myriad Demo** [80%, 11%, se]
...
7. [Custom HTML - Myriad Demo](aboutus.md#custom-html---myriad-demo)
...
| Option      | Setting                                                       |
| :---------- | :-----------                                                  |
| Title       | `About Us[span class="rt-title-tag"]Welcome to Myriad[/span]` |
| Show Title  | Yes                                                           |
| Position    | showcase-a                                                    |
| Status      | Published                                                     |
| Access      | Public                                                        |
...
<p><a href="http://www.rockettheme.com/joomla/templates/myriad" class="readon largemargintop">Download Myriad</a></p>
~~~
...
[aboutuspage12]: assets/page_aboutus_11.jpeg
