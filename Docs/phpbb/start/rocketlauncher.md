...
The first thing you will need to do is download a RocketLauncher. We recommend downloading the latest version in order to take advantage of the most recent features available in the platform.
